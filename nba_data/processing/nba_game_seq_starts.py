...
class GameSequenceStarters(Base):
    __tablename__ = 'game_sequence_starters'
    ...
    __table_args__ = (ForeignKeyConstraint([sport, season, game_id],
                                           ["games.sport",
                                            "games.season",
                                            "games.game_id"]),
                      UniqueConstraint(sport, season, game_id, model_event_num, person_id),
                      Index('ix_game_seq_start_model_nums', game_id, model_event_num, person_id),
                      {})
